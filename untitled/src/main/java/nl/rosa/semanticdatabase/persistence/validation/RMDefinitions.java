...
public class RMDefinitions extends RMBasicDefinitions {
    /**
    ...
    /**
     * built-in container nl.rosa.semanticdatabase.bmm.model.types used to represent class-class 1:N relations
     */
    ...
    public static String createSchemaId(String aModelPublisher, String aSchemaName, String aModelRelease) {
        ...
        if(aModelPublisher.isEmpty()) {
            builder.append("unknown");
        } else {
            builder.append(aModelPublisher);
        }
        builder.append("_");
        if(aSchemaName.isEmpty()) {
            builder.append("unknown");
        } else {
            builder.append(aSchemaName);
        }
        builder.append("_");
        if(aModelRelease.isEmpty()) {
            builder.append("unknown");
        } else {
