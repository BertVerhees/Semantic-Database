package nl.rosa.semanticdatabase.referencemodel.persistence.validation;
 ...
 */
    ...
    public enum MessageIds implements MessageCode {
        ec_documentation_text(I18n.register("Documentation")),
        ec_schemas_config_not_valid(I18n.register("Reference model schema(s) {0} specified in options not valid or not found in schema directories")),
        ec_schema_file_not_valid(I18n.register("Reference Model schema file {0} does not exist or not readable")),
        ec_schema_load_failure(I18n.register("Reference Model schema {0} load failure; reason: {1}")),
        ec_model_access_e3(I18n.register("Reference Model schema contains unknown type {0} (object add failed)")),
        ec_schema_load_failure_exception(I18n.register("Reference Model schema {0} load failure due to exception during processing")),
        ec_schema_dir_not_valid(I18n.register("Reference Model schema directory {0} does not exist or not readable")),
        ec_schema_dir_contains_no_schemas(I18n.register("Reference Model schema directory {0} does not contain any schemas")),
        ec_schema_dir_contains_no_valid_schemas(I18n.register("Reference Model schema directory {0} does not contain any valid schemas")),
        ec_model_access_e7(I18n.register("No Reference Model schema found for package ''{0}''")),
        ec_schema_post_merge_validate_fail(I18n.register("Reference Model schema {0} failed post-merge validation; errors:%N{1}")),
        ec_schema_included_schema_not_found(I18n.register("Reference Model included schema {0} not found or failed to load")),
        ec_schema_including_schema_not_valid(I18n.register("Reference Model including schema {0} not valid")),
        ec_schema_include_failed_to_load(I18n.register("Reference Model schema {0} includes a schema that failed to load")),
        ec_schema_basic_validation_failed(I18n.register("Reference Model schema {0} failed basic validation; errors:%N{1}")),
        ec_schema_unknown_exception(I18n.register("Unknown exception processing RM schemas")),
        ec_schema_assertion_violation(I18n.register("Assertion violation processing RM schemas; original recipient: {0}")),
        ...
        ec_schema_info_loaded(I18n.register("Reference Model schema {0} loaded: {1} primitive types, {2} class definitions")),
        ...
        ec_schema_duplicate_found(I18n.register("Duplicate instance of Reference Model model {0} found; original schema {1}; ignoring instance from schema {2}")),
        ec_schema_rm_missing(I18n.register("Reference Model for {0} meta-data missing/invalid: {1}")),
        ec_model_access_w5(I18n.register("Unknown Reference Model ''{0}'' mentioned in ''rm_schemas_load_list'' config setting (ignored)")),
        ec_schemas_no_load_list_found(I18n.register("No ''rm_schemas_load_list'' config setting found; attempting to load all schemas (change via Tools>Options)")),
        ec_schema_invalid_load_list(I18n.register("''rm_schemas_load_list'' config setting mentions non-existent schema {0}")),
        ec_schema_passed_with_warnings(I18n.register("Reference Model schema {0} passed basic validation with warnings:%N{1}")),
        ...
        ec_VERASS(I18n.register("Schema {0} BMM version {1} (assumed) incompatible with software version {2}")),
        ec_PTV(I18n.register("Schema {0} class definition {1} property {2} type {3} not defined in schema")),
        ...
        ec_MDLPK(I18n.register("Schema {0} archetype_closure_package {1} does not exist")),
        ec_PRDUP(I18n.register("Schema {0} class {1} duplicate property within class {2}")),
        ...
        ec_INCERR(I18n.register("Schema {0} included schema {1} validity failure")),
        ec_INCERR2(I18n.register("Schema {0} included schema {1} validity failure: {2}")),
        ...
        ec_class_not_in_definitions(I18n.register("Schema {0} defines class {1}, but class is not in defined classes or primitive types for package {2}")),
