...
public final class PRMSingleProperty extends PRMProperty<PRMSimpleType> {
     ...
     */
    private PRMSimpleType serializedTypeRef;
    ...
    @Override
    @JsonIgnore
    public PRMSimpleType getTypeRef() {
    ...
    public PRMSimpleType getSerializedTypeRef() {
        return serializedTypeRef;
    }

    public void setSerializedTypeRef(PRMSimpleType serializedTypeRef) {
