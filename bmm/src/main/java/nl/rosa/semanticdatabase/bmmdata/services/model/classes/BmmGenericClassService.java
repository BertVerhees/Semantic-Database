...
import nl.rosa.semanticdatabase.bmmdata.services.model_base_services.classes.BmmClassService;

/**
 * Default created on 25-5-2020
 */

public interface BmmGenericClassService extends
        CrudService<BmmGenericClass, Long>, BmmClassService {
}
