 ...
 * The development version of this document can be found at https://specifications.
 *openehr.
 *org/releases/LANG/latest/bmm.
 *html.
 *Known omissions or questions are indicated in the text with a 'to be determined' paragraph, as follows:TBD: (example To Be Determined paragraph)
 * 
 * 
 * 
 * 
 ...
 * The BMM remains compatible with P_BMM 2.
 *x, i.
 *e.
 * any existing .
 *bmm file can be parsed to create a v 3.
 *1.
 *0 BMM instance.
 *
 * 1.
 ...
 * class
 * generally refers to a class defined in a model expressed in BMM, i.
 *e.
 ...
 * type
 * generally refers to a type defined in a model expressed in BMM, i.
 *e.
 ...
 *The openEHR ADL Workbench (AWB) fully implements this specification, and provides a convenient way of illustrating BMM semantics.
