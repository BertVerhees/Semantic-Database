 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid initialiseWithLoadList ( aSchemaDirs: list<string>[1], aSchemaLoadList: list<string>[0..1] );
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid initialiseAll ( aSchemaDirs: list<string>[1] );
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBmmModelAccess bmmModel ( aModelKey: string[1]);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBoolean hasBmmModel ( aModelKey: string[1]);
