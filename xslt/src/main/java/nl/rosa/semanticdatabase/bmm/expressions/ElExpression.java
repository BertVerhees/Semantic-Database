 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxElExpression evalType ();
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBoolean postResult: result = evalType().equal( {bmmModel}.booleanTypeDefinition()) isBoolean ();
