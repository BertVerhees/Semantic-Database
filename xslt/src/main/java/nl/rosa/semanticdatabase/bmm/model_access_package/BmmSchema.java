...
*/
    ...
    void setBmmModel(value BmmSchema);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid merge ( other: bmmSchema[1] ) preState: state = stateIncludesPending preOtherValid: includesToProcess.has (includedSchema.schemaId);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBoolean postState: state = stateIncludesProcessed readToValidate ();
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxString schemaId ();
