 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBmmPackageContainer packageAtPath ( aPath: string[1]);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid doRecursivePackages ( action: elProcedureAgent[1] );
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBoolean hasPackagePath ( aPath: string[1]);
