...
*/
    ...
    void setClosedArgs(value ElAgent);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBmmSignature postResult: result = definition.signature evalType ();
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxBoolean postResultValidity: result = openArguments = void isCallable ();
