 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid merge ( other: pBmmSchema[1] ) preState: state = stateIncludesPending preOtherValid: includesToProcess.has (includedSchema.schemaId);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxPBmmSchema canonicalPackages ();
