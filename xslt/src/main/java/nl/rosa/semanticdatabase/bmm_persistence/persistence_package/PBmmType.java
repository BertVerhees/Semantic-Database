...
*/
    PBmmType getBmmType();
    void setBmmType(value PBmmType);
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxvoid createBmmType ( aSchema: bmmModel[1], aClassDef: bmmClass[1] );
 ...
 * 
*/
bmm_persistence/bmm_persistence_syntaxString asTypeString ();
