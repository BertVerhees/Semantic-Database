package nl.rosa.semanticdatabase.odin.utils;
...
public class OdinSerializationUtils {
     ...
     * @return
     */
    public static String buildOdinCardinalityInitialization(String propertyName, org.openehr.odin.IntegerIntervalObject cardinality) {
