package nl.rosa.semanticdatabase.odin.serializer;
...
public class OdinToJsonConverter {
    ...
    private void output(AdlParser.Object_value_blockContext valueBlockContext) {
        List<AdlParser.Keyed_objectContext> keyedObjectContexts = valueBlockContext.keyed_object();
    ...
    private void output(AdlParser.Primitive_list_valueContext listContext) {
        List<AdlParser.Primitive_valueContext> primitiveValueContexts = listContext.primitive_value();
        output.append("[");
        boolean first = true;
