...
public final class PSinglePropertyOpen extends PProperty<POpenType> {
     ...
     */
    private POpenType serializedTypeRef;
    ...
    public POpenType getSerializedTypeRef() {
        return serializedTypeRef;
    }

    public void setSerializedTypeRef(POpenType serializedTypeRef) {
