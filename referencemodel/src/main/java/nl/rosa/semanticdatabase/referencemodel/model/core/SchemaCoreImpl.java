...
import nl.rosa.semanticdatabase.referencemodel.model.persistence.validation.Definitions;
...
@Getter
@Setter
public class SchemaCoreImpl implements SchemaCore, Serializable {
    @Override
    public String getSchemaId() {
        return Definitions.createSchemaId(rmPublisher, schemaName, rmRelease);
    }

    public SchemaCoreImpl() {
        schemaContributors = new ArrayList<>();
        archetypeRmClosurePackages = new ArrayList<>();
    }

    public SchemaCoreImpl(String rmPublisher, String rmRelease, String schemaName) {
        this();
