...
@Getter
@Setter
public final class PSchema extends PPackageContainer {

    private Map<String, PClass> primitiveTypes;
    private Map<String, PClass> classDefinitions;
    ...
    public Map<String, PClass> getPrimitiveTypes() {
    ...
    public Map<String, PClass> getClassDefinitions() {
    ...
    public String getSchemaId() {
        return Definitions.createSchemaId(getRmPublisher(), getSchemaName(), getRmRelease());
    }
     ...
     * @return
     */
    public PClass findClassOrPrimitiveDefinition(String className) {
        PClass clasz = getClassDefinitions().get(className);
        if (clasz == null) {
    ...
    public PClass getClassDefinition(String className) {
     ...
     * @param action
     */
    public void doAllClasses(Consumer<PClass> action) {
