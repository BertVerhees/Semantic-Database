...
public class ValidationResult {
    ...
    /** The original schema in persisted format */
    private PSchema originalSchema;
    ...
    private PSchema schemaWithMergedIncludes;

    /**
     * packages in canonical format, so never "org.openehr.ehr", but "org" -> "openehr" -> "ehr"
     */
    private Map<String, PPackage> canonicalPackages = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
